...
Marketing and documentation site for [OpenSwap](https://github.com/citadel-foss/openswap) — an Atomic-Swap protocol using Taproot + MuSig2 over a decentralized censorship-resistant marketplace.
